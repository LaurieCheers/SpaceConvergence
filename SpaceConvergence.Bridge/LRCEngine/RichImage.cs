...
namespace LRCEngine
{
    ...
    public class RichImageLayer_Texture : RichImageLayer
    {
        ...
        Rotation90 rotation;
        bool modifiesRect;
        static _Dictionary<String, IDrawMode> drawModesByName = new _Dictionary<string, IDrawMode> {
        ...
        static _Dictionary<RichImageDrawMode, IDrawMode> drawModes = new _Dictionary<RichImageDrawMode, IDrawMode> {
